...
void Panel_RA8889::MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint16_t *data)
{
 ...
 *
 */
void Panel_RA8889::DrawPixels(uint16_t x, uint16_t y, uint16_t *data, uint32_t count)
{  

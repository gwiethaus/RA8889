...
void Panel_RA8889::SPI_DataWrite8(uint8_t data) {SPI_DataWrite(data);}
 ...
 * @note Note
 */
void Panel_RA8889::SPI_DataWrite16(uint16_t data)
{
  SPISetCS(0);                                 //SS_RESET;
  SPIRwByte(RA8889_SPI_DATAWRITE);             //0x80, Indica Dados para escrever
 ...
 * @note None
 */
void Panel_RA8889::SPI_DataWrite24(uint32_t data)
{
  SPISetCS(0);                                 //SS_RESET;
  SPIRwByte(RA8889_SPI_DATAWRITE);             //0x80, Indica Dados para escrever 
...
uint16_t Panel_RA8889::SPI_DataRead16(uint8_t address)
{
  uint16_t data;
  SPISetCS(0);                             //SS_RESET
 ...
 * @return None
 */
void Panel_RA8889::RegisterWrite(uint8_t reg, uint8_t data)
{
  SPI_CmdWrite(reg);
  SPI_DataWrite(data);
}
 ...
 */
uint8_t Panel_RA8889::RegisterRead(uint8_t reg)
{
  uint8_t temp;
  SPI_CmdWrite(reg);
  temp = SPI_DataRead();
 ...
 */
uint8_t Panel_RA8889::ReadIDCode(void)
 { 
  uint8_t datareg = 0;
  uint8_t temp;
...
//Habilita o PLL
void Panel_RA8889::PLL_Enable(void)
{
 ...
 */
void Panel_RA8889::PLL_ConfigClocks(uint8_t scanclk, uint8_t dramclk, uint8_t coreclk, uint8_t xtalclk)
{
 ...
 *
 */
void Panel_RA8889::XnWAIT_Mask(bool mask)
{
  uint8_t temp;
 ...
 *
 */
void Panel_RA8889::KeyScan_Enable(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_CCR);                       //0x01, Chip Configuration Register (CCR)
  temp = SPI_DataRead();
 ...
 * @param None
 */
void Panel_RA8889::I2CM_Enable(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_CCR);                       //0x01, Chip Configuration Register (CCR)
  temp = SPI_DataRead();
 ...
 * @param None
 */
void Panel_RA8889::SFlashSPI_Enable(bool b = true)
{
  uint8_t temp;
  SPI_CmdWrite(REG_CCR);                       //0x01, Chip Configuration Register (CCR)
  temp = SPI_DataRead();
 ...
 */
void Panel_RA8889::Select_MCU_ColorDepth(void)
{
 ...
 *
 */
void Panel_RA8889::IDEC_InterruptEnable(bool b)
{
  uint8_t temp;
 ...
 * @note None
 */
void Panel_RA8889::IDEC_ClearInterrupt_Flag(void)
{
  uint8_t temp;
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_ResumeInterrupt_Mask(bool b)
{
  uint8_t temp;
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_ExtInterruptInput_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_I2CMInterrupt_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_VsyncInterrupt_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_KeyScanInterrupt_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_GenericInterrupt_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_PWM1Interrupt_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XnINTR_PWM0Interrupt_Mask(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MINTFR);                    //0x0d, Mask Interrupt Flag Register (MINTFR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::IDEC_Unmask_Interrupt(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
void Panel_RA8889::IDEC_Mask_Interrupt(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_MINTFR);           //0x0d, page 1, Mask Interrupt Flag Register (MINTFR)
 ...
 * @note None
 */
void Panel_RA8889::IDEC_Interrupt_Mask(bool b)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_MINTFR);           //0x0d, page 1, Mask Interrupt Flag Register (MINTFR)
 ...
 * @note None
 */
void Panel_RA8889::GPIOF_PullUp_Enable(void)
{
  uint8_t temp;
 ...
 * @note None
 */
void Panel_RA8889::GPIOF_PullUp_Disable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOE_PullUp_Enable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOE_PullUp_Disable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOD_PullUp_Enable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOD_PullUp_Disable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOC_PullUp_Enable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOC_PullUp_Disable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XDB15_8_PullUp_Enable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XDB15_8_PullUp_Disable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XDB7_0_PullUp_Enable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::XDB7_0_PullUp_Disable(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PUENR);                     //0x0e, Pull- high control Register (PUENR)
  temp = SPI_DataRead();
 ...
 */
void Panel_RA8889::XPDAT18_GPIO_D7_Mode(void)
{
  uint8_t temp;
 ...
 */
void Panel_RA8889::XPDAT18_KOUT4_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 *       estiver em uso, liberando o pino para I/O digital.
 */
void Panel_RA8889::XPDAT17_GPIO_D5_Mode(void)
{
    /*
 ...
 *       matricial do RA8889 estiver habilitado.
 */
void Panel_RA8889::XPDAT17_KOUT2_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 *       estiver em uso, liberando o pino para I/O digital.
 */
void Panel_RA8889::XPDAT16_GPIO_D4_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 *       matricial do RA8889 estiver habilitado.
 */
void Panel_RA8889::XPDAT16_KOUT1_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 *       estiver em uso, liberando o pino para I/O digital.
 */
void Panel_RA8889::XPDAT9_GPIO_D3_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 *       matricial do RA8889 estiver habilitado.
 */
void Panel_RA8889::XPDAT9_KOUT3_Mode(void)
{
    /*
 ...
 *       estiver em uso, liberando o pino para I/O digital.
 */
void Panel_RA8889::XPDAT8_GPIO_D2_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 *       matricial do RA8889 estiver habilitado.
 */
void Panel_RA8889::XPDAT8_KIN3_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 */
void Panel_RA8889::XPDAT2_GPIO_D6_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 * @note Altera apenas o bit 2 do registrador PSFSR, preservando os demais bits.
 */
void Panel_RA8889::XPDAT2_KIN4_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 * @param None
 */
void Panel_RA8889::XPDAT1_GPIO_D1_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 * @param None
 */
void Panel_RA8889::XPDAT1_KIN2_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 * @param None
 */
void Panel_RA8889::XPDAT0_GPIO_D0_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 * @param None
 */
void Panel_RA8889::XPDAT0_KIN1_Mode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PSFSR);                     //0x0f, PDAT for PIO/Key Function Select Register (PSFSR)
  temp = SPI_DataRead();
 ...
 * @note PIP 1 window always on top of PIP 2 window
 */
void Panel_RA8889::PIP1_Enable(bool b)
{
  uint8_t temp;
 ...
 * @note PIP 1 window always on top of PIP 2 window
 */
void Panel_RA8889::PIP2_Enable(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MPWCTR);                    //0x10, Main/PIP Window Control Register
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PIP_Select_Parameter(ePIPSelect pip)
{
  uint8_t temp;
  SPI_CmdWrite(REG_MPWCTR);                    //0x10, Main/PIP Window Control Register
  temp = SPI_DataRead();
 ...
 *
 */
void Panel_RA8889::PIP1_Window_ColorDepth(eColorDepthBPP bpp)
{
  uint8_t temp;
  uint8_t bit;
 ...
 *
 */
void Panel_RA8889::PIP1_Window_ColorDepth_8bpp(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
  temp = SPI_DataRead();
 ...
 *
 */
void Panel_RA8889::PIP1_Window_ColorDepth_16bpp(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
  temp = SPI_DataRead();
 ...
 *
 */
void Panel_RA8889::PIP1_Window_ColorDepth_24bpp(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
  temp = SPI_DataRead();
 ...
 *
 */
void Panel_RA8889::PIP2_Window_ColorDepth(eColorDepthBPP bpp)
{
  uint8_t temp;
  uint8_t bit;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
 ...
 *
 */
void Panel_RA8889::PIP2_Window_ColorDepth_8bpp(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
  temp = SPI_DataRead();
 ...
 *
 */
void Panel_RA8889::PIP2_Window_ColorDepth_16bpp(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
  temp = SPI_DataRead();
 ...
 *
 */
void Panel_RA8889::PIP2_Window_ColorDepth_24bpp(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PIPCDEP);                   //0x11, PIP Window Color Depth Setting (PIPCDEP)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PCLK_EdgeType(ePCLKEdge edge)
{
  uint8_t temp;
  SPI_CmdWrite(REG_DPCR);                      //0x12, Display Configuration Register (DPCR)
  temp = SPI_DataRead();                       //Lê valor atual do registrador
 ...
 *       
 */
void Panel_RA8889::DisplayTestBar(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_DPCR);             //0x12, Display Configuration Register (DPCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PDATA_ColorFmt(ePDATAColorFmt fmt)
{
  uint8_t temp;
  SPI_CmdWrite(REG_DPCR);                      //0x12, Display Configuration Register (DPCR)
  temp = SPI_DataRead();                       //Lê valor atual do registrador
 ...
 * @note None
 */
void Panel_RA8889::HSYNC_Polarity(eHSYNCPolarity val)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();                       //Lê valor atual do registrador
 ...
 * @note None
 */
void Panel_RA8889::VSYNC_Polarity(eVSYNCPolarity val)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();                       //Lê valor atual do registrador
 ...
 * @note None
 */
void Panel_RA8889::DE_Polarity(eDEPolarity val)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();                       //Lê valor atual do registrador
 ...
 * @note None
 */
void Panel_RA8889::DE_IdleStateLow(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::DE_IdleStateHigh(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PCLK_IdleStateLow(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PCLK_IdleStateHigh(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PDAT_IdleStateLow(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::PDAT_IdleStateHigh(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::HSYNC_IdleStateLow(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::HSYNC_IdleStateHigh(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::VSYNC_IdleStateLow(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::VSYNC_IdleStateHigh(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PCSR);                      //0x13, Panel scan Clock and Data Setting Register (PCSR)
  temp = SPI_DataRead();
 ...
 */
void Panel_RA8889::PIP_Display_StartXY(uint16_t Wx, uint16_t Hy)
{
 ...
 *       É necessário configurar previamente qual PIP (1 ou 2) será afetado.
  */
void Panel_RA8889::PIP_Image_StartAddress(uint32_t addr)
{
 ...
 * @note None
 */
void Panel_RA8889::AVI_ShadowPIP_StartAddress(uint32_t addr)
{
  PageSwitch(ePageReg::Page1);
 ...
 */
void Panel_RA8889::PIP_Image_Width(uint16_t Wx)
{
 ...
 *       superior-esquerdo da janela.
 */
void Panel_RA8889::PIP_WindowImage_StartXY(uint16_t Wx, uint16_t Hy)
{
 ...
 */
void Panel_RA8889::PIP_Window_WidthHeight(uint16_t Wx, uint16_t Hy)
{
 ...
 */
void Panel_RA8889::GammaCorrection_Enable(bool b)
{
  uint8_t temp;
 ...
 */
void Panel_RA8889::GammaTableforBlue(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note This function only selects the table. You must write gamma data afterward.
 */
void Panel_RA8889::GammaTableforGreen(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note This function only selects the table. You must write gamma data afterward.
 */
void Panel_RA8889::GammaTableforRed(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 */
void Panel_RA8889::CursorGraphic_Enable(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorGraphic_Set1(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorGraphic_Set2(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorGraphic_Set3(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorGraphic_Set4(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorText_Enable(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorText_Blinking_Enable(bool b)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GTCCR);                     //0x3c,  Graphic / Text Cursor Control Register (GTCCR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::CursorText_BlinkingTimeFrames(uint8_t frames)
{
 ...
 *       Wx, Hy iniciam em 0
 */
void Panel_RA8889::CursorText_Dimensions(uint8_t Wx, uint8_t Hy)
{
 ...
 */
void Panel_RA8889::CursorGraphic_Position(uint16_t Wx, uint16_t Hy)
{
 ...
 */
void Panel_RA8889::CursorGraphic_Color0(uint8_t color)
{
 ...
 *       Combinando Color 0 e Color 1, você pode ter cursores bicolores ou com efeitos de transparência, dependendo do Set selecionado.
 */
void Panel_RA8889::CursorGraphic_Color1(uint8_t color)
{
 ...
 */
void Panel_RA8889::SPIM_SelectableBusMode(void)
{
  uint8_t temp;
 ...
 */
void Panel_RA8889::SPIM_FixedBusMode(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_PAGE_SWITCH); //0x46, Page 0, Page Switch
  temp = SPI_DataRead();
 ...
 *           Modo RA8889 padrão
 */
void Panel_RA8889::SPIM_ClockDivided_2(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
 ...
 *           Modo RA8889 padrão
 */
void Panel_RA8889::SPIM_ClockDivided_1(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_PAGE_SWITCH);               //0x46, Page 1, Page Switch
...
bool Panel_RA8889::Memory_IsXYMode(void) { return Memory_IsBlockMode(); }
 ...
 * @note None
 */
void Panel_RA8889::BTE_S0_ColorDeph_8bpp(void)
{ 
  uint8_t temp;
  SPI_CmdWrite(REG_BTE_COLR);                     //0x92, Source 0/1 & Destination Color Depth (BTE_COLR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::BTE_S0_ColorDeph_16bpp(void)
{ 
  uint8_t temp;
  SPI_CmdWrite(REG_BTE_COLR);                     //0x92, Source 0/1 & Destination Color Depth (BTE_COLR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::BTE_S0_ColorDeph_24bpp(void)
{ 
  uint8_t temp;
  SPI_CmdWrite(REG_BTE_COLR);                     //0x92, Source 0/1 & Destination Color Depth (BTE_COLR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::BTE_Destination_ColorDeph_16bpp(void)
{ 
  uint8_t temp;
  SPI_CmdWrite(REG_BTE_COLR);                     //0x92, Source 0/1 & Destination Color Depth (BTE_COLR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::BTE_Destination_ColorDeph_24bpp(void)
{ 
  uint8_t temp;
  SPI_CmdWrite(REG_BTE_COLR);                     //0x92, Source 0/1 & Destination Color Depth (BTE_COLR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
uint8_t Panel_RA8889::Media_Error_Flag(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
void Panel_RA8889::Media_DecodeBusy(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  //case4: check AVI
...
void Panel_RA8889::Media_DecodeWaitReady(void) { Media_DecodeBusy(); }
 ...
 * @note None
 */
uint8_t Panel_RA8889::MediaDecodeBusy(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  //case4: check AVI
 ...
 * @note None
 */
uint8_t Panel_RA8889::Media_Fifo_Empty(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_VC1);                       //0xa0, page 1, Video Control (VC)
 ...
 * @note None
 */
uint16_t Panel_RA8889::Media_HeaderImageHeight(void)
{
  uint16_t temp = 0;
  PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
uint16_t Panel_RA8889::Media_HeaderImageWidth(void)
{
  uint16_t temp = 0;
  PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
uint32_t Panel_RA8889::AVI_HeaderFramePeriod(void)
{
  uint32_t temp = 0;
  PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
void Panel_RA8889::IDEC_Reset(void)
{
  PageSwitch(ePageReg::Page1);
 ...
 * @result None
 */
void Panel_RA8889::SFI_Select_24bitAddress(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_SFL_CTRL);                  //0xb7, Serial Flash/ROM Controller Register (SFL_CTRL)
  temp = SPI_DataRead();
 ...
 * @result None
 */
void Panel_RA8889::SFI_Select_32bitAddress(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_SFL_CTRL);                  //0xb7, Serial Flash/ROM Controller Register (SFL_CTRL)
  temp = SPI_DataRead();
 ...
 * @result None
 */
void Panel_RA8889::IDEC_SFI_Select_ROM(eSFIROM sfirom)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
 ...
 * @result None
 */
void Panel_RA8889::Font_DMA_Select_Bus0(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::Font_DMA_Select_Bus1(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Select_Bus0(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Select_Bus1(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Destination_ColorDepth_8bpp(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Destination_ColorDepth_16bpp(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Destination_ColorDepth_24bpp(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Starts_Decoding(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_WaitReady(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  do {
 ...
 *         1: IDEC ist Busy 
 */
uint8_t Panel_RA8889::IDEC_Busy(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL0);                  //0xb6, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL0)
 ...
 * @result None
 */
void Panel_RA8889::SFI_SelectROM_CS0 (void)
{
  uint8_t temp;
 ...
 * @result None
 */
void Panel_RA8889::SFI_SelectROM_CS1 (void)
{
  uint8_t temp;
 ...
 * @result None
 */
void Panel_RA8889::SFI_SelectROM_CS2(void)
{
  uint8_t temp;
 ...
 * @result None
 */
void Panel_RA8889::SFI_SelectROM_CS3(void)
{
  uint8_t temp;
 ...
 *       Apenas para RA8889.
 */
inline void Panel_RA8889::SFI_SelectROM_CS_Fast(uint8_t cs_num)
{
 ...
 * @result None
 */
void Panel_RA8889::IDEC_SFI_Select_24bitAddress(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL1);                    //0xb7, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL1)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_SFI_Select_32bitAddress(void)
{
  uint8_t temp;
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_CTRL1);                    //0xb7, page 1, Serial flash AVI/JPG/BMP (IDEC_CTRL1)
 ...
 * @result None
 */
void Panel_RA8889::IDEC_SPI_ClockDivide(uint8_t spiclockdivide)
{
  uint32_t temp = 0;
  PageSwitch(ePageReg::Page1);
 ...
 */
void Panel_RA8889::IDEC_Source_StartAddress(uint32_t addr) 
{
  PageSwitch(ePageReg::Page1);
  // Array com os registradores consecutivos
 ...
 * @result None
 */
void Panel_RA8889::SPIM_Select_Bus0(void)
{
  uint8_t temp;
 ...
 * @result None
 */
 void Panel_RA8889::SPIM_Select_Bus1(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_SPIMBS);                  //0xc5, SPI Master Bus Select (SPIMBS)
  temp = SPI_DataRead();
 ...
 * @result None
 */
void Panel_RA8889::SPIM_RxLatchEdge_Rising(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_SPIMBS);                  //0xc5, SPI Master Bus Select (SPIMBS)
  temp = SPI_DataRead();
 ...
 * @result None
 */
void Panel_RA8889::SPIM_RxLatchEdge_Falling(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_SPIMBS);                  //0xc5, SPI Master Bus Select (SPIMBS)
  temp = SPI_DataRead();
 ...
 * @result None
 */
void Panel_RA8889::IDEC_Destination_UpperLeftCorner(uint16_t Wx, uint16_t Hy)
{
  PageSwitch(ePageReg::Page1);
 ...
 * @result None
 */
void Panel_RA8889::IDEC_AVI_Decoding_PIP1_Shadow(void)
{
  PageSwitch(ePageReg::Page1);
 ...
 * @result None
 */
void Panel_RA8889::IDEC_AVI_Decoding_PIP2_Shadow(void)
{
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_PIP);                  //0xc5, page 1, IDEC AVI PIP controller (IDEC_PIP)
  SPI_DataWrite(0x01);
 ...
 * @result None
 */
void Panel_RA8889::IDEC_AVI_Decoding_PIP1_NoShadow(void)
{
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_PIP);                  //0xc5, page 1, IDEC AVI PIP controller (IDEC_PIP)
  SPI_DataWrite(0x02);
 ...
 * @result None
 */
void Panel_RA8889::IDEC_AVI_SetMode(eAVIMode mode)
{
  PageSwitch(ePageReg::Page1);
  SPI_CmdWrite(REG_IDEC_PIP);                  //0xc5, page 1, IDEC AVI PIP controller (IDEC_PIP)
 ...
 */
void Panel_RA8889::IDEC_SetImageDMANumber(uint32_t num)
{
  PageSwitch(ePageReg::Page1);
  // Array com os registradores consecutivos
 ...
 * @note None
 */
void Panel_RA8889::SetTextParameter0(uint8_t sourceselect, uint8_t sizeselect, uint8_t isoselect)
{
  uint8_t temp;
  SPI_CmdWrite(REG_CCR0);                      //0xcc, Character Control Register 0 (CCR0)
  temp = SPI_DataRead();                       
 ...
 * @note None
 */
void Panel_RA8889::SetTextParameter1(uint8_t align, uint8_t chromakey, uint8_t widthenlarge, uint8_t heightenlarge)
{
  uint8_t temp;
  SPI_CmdWrite(REG_CCR1);                      //0xcd, Character Control Register 1 (CCR1)
  temp = SPI_DataRead();                       
 ...
 */
void Panel_RA8889::IDEC_Destination_StartAddress(uint32_t addr) 
{
  PageSwitch(ePageReg::Page1);
  // Array com os registradores consecutivos
 ...
 */
void Panel_RA8889::IDEC_Destination_ImageWidth(uint16_t Wx)
{
  PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
void Panel_RA8889::AVI_Pause(void)
{
    PageSwitch(ePageReg::Page1);
 ...
 * @note None
 */
void Panel_RA8889::AVI_Stop(void)
{
    PageSwitch(ePageReg::Page1);
 ...
 */
void Panel_RA8889::I2CM_SetFrequency(uint32_t xscl_hz, uint16_t coreclk_mhz)
{
 ...
 * @note None
 */
void Panel_RA8889::I2CM_WriteWithStart(void)
{
 ...
 * @note None
 */
void Panel_RA8889::I2CM_Stop(void)
{
  SPI_CmdWrite(REG_IICMCMDR);         //0xe9, IIC Master Command Register (IICMCMDR)
 ...
 * @note None
 */
void Panel_RA8889::I2CM_ReadWithAck(void)
{
  SPI_CmdWrite(REG_IICMCMDR);         //0xe9, IIC Master Command Register (IICMCMDR)
 ...
 * @note None
 */
void Panel_RA8889::I2CM_ReadWithNack(void)
{
  SPI_CmdWrite(REG_IICMCMDR);         //0xe9, IIC Master Command Register (IICMCMDR)
 ...
 * @note None
 */
void Panel_RA8889::I2CM_Write(void)
{
  SPI_CmdWrite(REG_IICMCMDR);         //0xe9, IIC Master Command Register (IICMCMDR)
 ...
 * @note None
 */
bool Panel_RA8889::I2CM_CheckSlaveACK(void)
{
  uint8_t temp;
 ...
 * @note None
 */
bool Panel_RA8889::I2CM_BusBusy(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_IICMCMDR);         //0xea, IIC Master Status Register (IICMSTUR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
uint8_t Panel_RA8889::I2CM_TransmitProgress(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_IICMCMDR);                  //0xea, IIC Master Status Register (IICMSTUR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
uint8_t Panel_RA8889::I2CM_Arbitration(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_IICMCMDR);                  //0xea, IIC Master Status Register (IICMSTUR)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOA_InOut(uint8_t dir)
{
 ...
 * @note None
 */
void Panel_RA8889::GPIOA_Write(uint8_t value)
{
 ...
 */
uint8_t Panel_RA8889::GPIOA_Read(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GPIOA);                     //0xf1, GPIO-A (GPIOA)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOB_Write(uint8_t value)
{
 ...
 */
uint8_t Panel_RA8889::GPIOB_Read(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GPIOB);                     //0xf2, GPIO-B (GPIOB)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOC_InOut(uint8_t dir)
{
 ...
 */
void Panel_RA8889::GPIOC_Write(uint8_t value)
{
 ...
 *       GPIO_C[4:0] : XnSFCS1, XnSFCS0, XMISO, XMOSI, XSCLK.
 */
uint8_t Panel_RA8889::GPIOC_Read(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GPIOC);                     //0xf4, GPIO-C (GPIOC)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOD_InOut(uint8_t dir)
{
 ...
 * @note None
 */
void Panel_RA8889::GPIOD_Write(uint8_t value)
{
 ...
 * @note None
 */
uint8_t Panel_RA8889::GPIOD_Read(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GPIOD);                     //0xf6, GPIO-D (GPIOD)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOE_InOut(uint8_t dir)
{
 ...
 * @note None
 */
void Panel_RA8889::GPIOE_Write(uint8_t value)
{
 ...
 * @note None
 */
uint8_t Panel_RA8889::GPIOE_Read(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GPIOE);                     //0xf8, GPIO-E (GPIOE)
  temp = SPI_DataRead();
 ...
 * @note None
 */
void Panel_RA8889::GPIOF_InOut(uint8_t dir)
{
 ...
 * @note None
 */
void Panel_RA8889::GPIOF_Write(uint8_t value)
{
 ...
 * @note None
 */
uint8_t Panel_RA8889::GPIOF_Read(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_GPIOF);                     //0xfa, GPIO-F (GPIOF)
  temp = SPI_DataRead();
 ...
 * 
 */
void Panel_RA8889::KeyScan_LongKeyEnable(bool b = true)
{
  uint8_t temp;
 ...
 * 
 */
void Panel_RA8889::KeyScan_Freguency(uint8_t setx)
{
  uint8_t temp;
  SPI_CmdWrite(REG_KSCR1);     //0xfb, Key-Scan Control Register 1 (KSCR1)
  temp = SPI_DataRead();       //
 ...
 * 
 */
void Panel_RA8889::KeyScan_WakeupFunctionEnable(bool b = true)
{
  uint8_t temp;
 ...
 */
void Panel_RA8889::KeyScan_LongKeyTimingAdjust(uint8_t setx)
{
  uint8_t temp;
  SPI_CmdWrite(REG_KSCR2);                //0xfc, Key-Scan Controller Register 2 (KSCR2)
  temp = SPI_DataRead();
 ...
 * 
 */
uint8_t Panel_RA8889::KeyScan_KeyHits(void)
{
  uint8_t temp;
  SPI_CmdWrite(REG_KSCR2);              //0xfc, Key-Scan Controller Register 2 (KSCR2)
 ...
 * 
 */
uint8_t Panel_RA8889::KeyScan_ReadKeyStrobeData0(void)
{
  uint8_t temp;
 ...
 * 
 */
uint8_t Panel_RA8889::KeyScan_ReadKeyStrobeData1(void)
{
  uint8_t temp;
 ...
 * 
 */
uint8_t Panel_RA8889::KeyScan_ReadKeyStrobeData2(void)
{
  uint8_t temp;
 ...
 */
uint8_t Panel_RA8889::KeyScan_ReadKeyStrobeData(uint8_t index)
{
    switch(index)
    {
...
void Panel_RA8889::MPU8_8bpp_MemoryWrite(
...
void Panel_RA8889::MPU8_16bpp_MemoryWrite(
                                          uint16_t x,                    // x of coordinate
                                          uint16_t y,                    // y of coordinate
                                          uint16_t w ,                   // width
                                          uint16_t h ,                   // height
...
void Panel_RA8889::MPU8_24bpp_MemoryWrite(
                                          uint16_t x,                    // x of coordinate
                                          uint16_t y,                    // y of coordinate
                                          uint16_t w ,                   // width
                                          uint16_t h ,                   // height
...
void Panel_RA8889::MPU16_16bpp_MemoryWrite(
                                           uint16_t x,                    // x of coordinate
                                           uint16_t y,                    // y of coordinate
                                           uint16_t w ,                   // width
                                           uint16_t h ,                   // height
...
void Panel_RA8889::MPU16_24bpp_Mode1_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint16_t *data)
{
  uint16_t i;                                  //posicao da linha
  uint16_t j;                                  //posicao da coluna
  if (!IsGraphicMode()) GraphicMode();         //Se no modo texto, muda para o modo grafico
 ...
 * @note None
 */
void Panel_RA8889::DMA_24bit_Block(uint8_t scs,         // scs: Select SPI : SCS0/SCS1
 ...
 * @note None
 */
void Panel_RA8889::DMA_32bit(uint8_t clk,       // Clk : SPI Clock = System Clock /{(Clk+1)*2}
                             uint16_t x1,       // X of DMA Coordinate
                             uint16_t y1,       // Y of DMA Coordinate
                             uint16_t Wx,       // DMA Block width
                             uint16_t Hy,       // DMA Block height
 ...
 * @note None
 */
void Panel_RA8889::Switch_24bitsTo32bits(uint8_t bus, uint8_t scs)
{
  SFlashSPI_Enable(true);
 ...
 * @note None
 */
void Panel_RA8889::DMA_24bitAddressBlockMode(uint8_t bus_select,
                                             uint8_t scs_select,
                                             uint8_t clk_div,
                                             uint16_t x0,
                                             uint16_t y0,
                                            ...
                                            )
{
  ...
  if(scs_select==0) {
    SFI_SelectROM_CS0();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT0<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_24BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  } else if(scs_select==1) {
    SFI_SelectROM_CS1();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT1<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_24BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  } else if(scs_select==2) {
    SFI_SelectROM_CS2();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT2<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_24BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  } else if(scs_select==3) {
    SFI_SelectROM_CS3();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT3<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_24BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  }
  ...
  RegisterWrite(REG_DMA_CTRL,RA8889_DMA_START);//b6h 
  CoreTask_WaitReady(); 
 }
 ...
 * @note None
 */
 void Panel_RA8889::DMA_32bitAddressBlockMode(uint8_t bus_select,
                                              uint8_t scs_select,
                                              uint8_t clk_div,
                                              uint16_t x0,
                                              uint16_t y0,
                                             ...
                                             )
{
  ...
  if(scs_select==0) {
    SFI_SelectROM_CS0();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT0<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_32BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  } else if(scs_select==1) {
    SFI_SelectROM_CS1();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT1<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_32BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  } else if(scs_select==2) {
    SFI_SelectROM_CS2();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT2<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_32BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  } else if(scs_select==3) {
    SFI_SelectROM_CS3();
    RegisterWrite(RA8889_SFL_CTRL,RA8889_SERIAL_FLASH_SELECT3<<7|RA8889_SERIAL_FLASH_DMA_MODE<<6|RA8889_SERIAL_FLASH_ADDR_32BIT<<5|RA8889_FOLLOW_RA8875_MODE<<4|RA8889_SPI_FAST_READ_8DUMMY);
  }   
 ...
 * @note None
 */
void Panel_RA8889::DMA_24bitAddressLinearMode(uint8_t bus_select,
                                              uint8_t scs_select,
                                              uint8_t clk_div,
 ...
 * @note None
 */
 void Panel_RA8889::DMA_32bitAddressLinearMode(uint8_t bus_select,
                                               uint8_t scs_select,
                                               uint8_t clk_div,
                                               uint32_t source_addr,
                                               uint32_t des_address,
...
void Panel_RA8889::PIP(bool On_Off,                   // 0 : disable PIP, 1 : enable PIP, 2 : To maintain the original state
 ...
 * @note None
 */
void Panel_RA8889::AVI_Window(bool on_off)
{
  PIP1_Enable(on_off);
}
 ...
 *
 */
uint8_t Panel_RA8889::Color16To8bpp(uint16_t color) 
{
 ...
 *
 */
uint16_t Panel_RA8889::Color8To16bpp(uint8_t color8) 
{
 ...
 * @return uint16_t Cor convertida em RGB565 (16 bits).
 */
uint16_t Panel_RA8889::Color24To16bpp(uint32_t color24)
{
 ...
 */
uint32_t Panel_RA8889::Color16To24bpp(uint16_t color16)
{
 ...
 * @note None
 */
void Panel_RA8889::SetPixelPosXY(uint16_t x, uint16_t y)
{
  GotoText_XY(x,y);
}
 ...
 * @note None
 */
void Panel_RA8889::SetPixelPos(pospixel_t pos)
{
 ...
 * @note None
 */
uint16_t Panel_RA8889::GetPixelPosX()
{
  uint16_t pos;
  SPI_CmdWrite(REG_F_CURX0);                   //0x63, Text Write X-coordinates Register 0 (F_CURX0)
 ...
 * @note None
 */
uint16_t Panel_RA8889::GetPixelPosY()
{
  uint16_t pos;
  SPI_CmdWrite(REG_F_CURY0);                   //0x65, Text Write Y-coordinates Register 0 (F_CURY0)
 ...
 * @note None
 */
pospixel_t Panel_RA8889::GetPixelPosXY()
{
  pospixel_t pos;
  SPI_CmdWrite(REG_F_CURX0);                   //0x63, Text Write X-coordinates Register 0 (F_CURX0)
 ...
 *   SPI_DataWrite24bpp()
 */
void Panel_RA8889::PutPixel(uint16_t x,      // x of coordinate
                            uint16_t y,      // y of coordinate
...
void Panel_RA8889::PushBlock(uint16_t x, 
                             uint16_t y,
 ...
 *
 */
void Panel_RA8889::ShowText(char *str)
{  
  SPI_CmdWrite(REG_MRWDP);                     //0x04, Memory Data Read/Write Port (MRWDP)
 ...
 *
 */
void Panel_RA8889::PutChar8x12(uint16_t x, uint16_t y, uint32_t fgcolor, uint32_t bgcolor, bool bgtransparent, uint8_t code)
{ 
  uint16_t i = 0;
  uint16_t j = 0;
  uint8_t tmpchar = 0;
 ...
 *
 */
void Panel_RA8889::PutString8x12(uint16_t x, uint16_t y, uint32_t fgcolor, uint32_t bgcolor, bool bgtransparent, char *ptr)
{
  uint16_t i = 0;
 ...
 *
 */
void Panel_RA8889::PutChar16x24(uint16_t x, uint16_t y, uint32_t fgcolor, uint32_t bgcolor, bool bgtransparent, uint8_t code)
{ 
 ...
 *
 */
void Panel_RA8889::PutString16x24(uint16_t x, uint16_t y, uint32_t fgcolor, uint32_t bgcolor, bool bgtransparent, char *ptr)
{
  uint16_t i = 0;
 ...
 *
 */
void Panel_RA8889::PutChar32x48(uint16_t x, uint16_t y, uint32_t fgcolor, uint32_t bgcolor, bool bgtransparent, uint8_t code)
{ 
 ...
 *
 */
void Panel_RA8889::PutString32x48(uint16_t x, uint16_t y, uint32_t fgcolor, uint32_t bgcolor, bool bgtransparent, char *ptr)
{
  uint16_t i = 0;
 ...
 * @note None
 */
void Panel_RA8889::BTE_MemoryCopy(uint32_t s0_addr,
 ...
 *
 */
void Panel_RA8889::BTE_MemoryCopyWithROP(uint32_t s0_addr,
                                         uint16_t s0_image_width,
                                         uint16_t s0_x,
                                         uint16_t s0_y,
                                         uint32_t s1_addr,
 ...
 * @note None
 */
void Panel_RA8889::BTE_MemoryCopyWithChromaKey(uint32_t s0_addr,
                                               uint16_t s0_image_width,
                                               uint16_t s0_x,
                                               uint16_t s0_y,
                                               uint32_t des_addr,
 ...
 * @note None
 */
void Panel_RA8889::BTE_MPUWriteWithROP(uint32_t s1_addr,
                                       uint16_t s1_image_width,
                                       uint16_t s1_x,
                                       uint16_t s1_y,
                                       uint32_t des_addr,
 ...
 * @note None
 */
void Panel_RA8889::BTE_MPUWriteWithChromaKey(uint32_t des_addr,
                                             uint16_t des_image_width, 
                                             uint16_t des_x,
                                             uint16_t des_y,
                                             uint16_t width,
 ...
 * @note None
 */
void Panel_RA8889::BTE_MPUWriteColorExpansion(uint32_t des_addr,
                                              uint16_t des_image_width, 
                                              uint16_t des_x,
                                              uint16_t des_y,
                                              uint16_t width,
 ...
 */
void Panel_RA8889::BTE_MPUWriteColorExpansionWithChromaKey(uint32_t des_addr,
                                                           uint16_t des_image_width, 
                                                           uint16_t des_x,
                                                           uint16_t des_y,
                                                           uint16_t width,
 ...
 *       write data after setting
 */
void Panel_RA8889::BTE_MemoryCopyWith_ARGB8888(uint32_t s1_addr,
                                               uint16_t s1_image_width,
                                               uint32_t des_addr,
                                               uint16_t des_image_width,
                                               uint16_t des_x,

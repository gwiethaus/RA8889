...
enum class eTristeza : uint8_t {
  bpp8  = 0,                     //Color Depth 8bpp
  bpp16 = 1,                    //Color Depth 16bpp
  bpp24 = 2                     //Color Depth 24bpp
};
...
class Panel_RA8889 {
	...
	public:
		...
		void DrawPixels(uint16_t x, uint16_t y, uint32_t color, uint32_t data[], uint16_t count);
        ...
        void Text(uint16_t x, uint16_t y, char *str, uint32_t forecolor, uint32_t backcolor);
        ...
        void MPU8_8bpp_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint8_t *data_array);
        void MPU8_16bpp_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint8_t *data_array);
        void MPU8_24bpp_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint8_t *data_array);
        void MPU16_16bpp_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint16_t *data_array);
        void MPU16_24bpp_Mode1_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint16_t *data_array);
        void MPU16_24bpp_Mode2_MemoryWrite(uint16_t x,uint16_t y, uint16_t w , uint16_t h , const uint16_t *data_array);
